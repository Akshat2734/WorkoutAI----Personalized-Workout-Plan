...
// import the type correctly:
import ExerciseGallery, { type ExerciseItem } from "@/components/ExerciseGallery";
...
const EXERCISES: ExerciseItem[] = [
  {
    ...
    description: "Keep your core tight, elbows ~45°, and full range of motion.",
    link: "/exercises/1",
  },
  {
    id: 2,
    ...
    bodyPart: "Lower Body",
    equipment: "Bodyweight",
    description: "Sit back, track knees over toes, and keep heels planted.",
    link: "/exercises/2",
  },
  {
    id: 3,
    ...
    bodyPart: "Core",
    equipment: "Mat",
    description: "Neutral spine, glutes tight, and don’t let hips sag.",
    link: "/exercises/3",
  },
];
...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen text-foreground overflow-hidden">
      ...
      {/* Replace <UserPrograms /> */}
      <ExerciseGallery
        title="AI-Enhanced Exercises"
        subtitle="Watch form videos and see key details at a glance"
        exercises={EXERCISES}  // plain data; no function prop
      />
    </div>
  );
}
